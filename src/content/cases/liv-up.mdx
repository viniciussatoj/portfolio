...
heroImage: /cases/liv-up/hero.png
...
<Split>
  <div>
    <Numbered n="1" heading="At first we explored a Favorites page">
      <Figure src="/cases/liv-up/favorites.png" max={388} alt="Favorites page listing saved items with a Since you enjoyed suggestion block" />
  ...
  <div>
    <Numbered n="2" heading="Then moved the position of recommendations">
      <Figure src="/cases/liv-up/inline-recommendations.png" max={388} alt="Recommendations placed inline, next to the item they relate to" />
...
<Numbered n="3" heading="Pivoted to a shopping list that encourages the discovery of new products">
  <Row cols={3}>
    <Figure src="/cases/liv-up/list-empty-state.png" alt="Empty shopping list seeded with items from past orders" />
    <Figure src="/cases/liv-up/list-shortcuts.png" alt="Shopping list with Best sellers, Recommendations, Previously bought and Best rated shortcuts" />
    <Figure src="/cases/liv-up/list-search.png" alt="Shopping list with a search field for adding items without leaving the page" />
  </Row>
